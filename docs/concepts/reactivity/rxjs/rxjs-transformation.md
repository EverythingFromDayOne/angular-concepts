---
article_id: rxjs-transformation
description: Pipeable operators return a new Observable instead of mutating the source, and transformation operators reshape each value in flight
